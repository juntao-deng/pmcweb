wdefine(function(){
	...
	function openSummary(itemId){
		AppUtil.navigateToDialog("monitor/threadsummary", {itemId: itemId, urlBase: 'threadinfoshis'}, {title: "Thread Summary", width: "800", height: "500"});
	}
	...
	function doFetch() {
		...
		model.reqParam('fetchType', "stages");
